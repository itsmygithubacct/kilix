"""The canonical text shell shared by Kilix's built-in settings TUI.

The independently installable TUI utilities use the same visual contract:
...
on the last row.  This stdlib-only copy keeps the core Kilix command
self-contained.
"""
