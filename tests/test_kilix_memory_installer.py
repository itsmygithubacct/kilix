...
class MemoryCompatibilityInstallerTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_installs_unified_launcher_without_managed_source_cache(self):
        ...
        self.assertTrue(os.access(self.prefix / "bin" / "kilix-memory", os.X_OK))
        self.assertFalse((self.source / ".kilix-memory-sources").exists())
